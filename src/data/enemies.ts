...
export const ENEMIES: EnemyDef[] = [
  {
    ...
    attackFrequency: 3,
    special: null,
    sprite: "/enemy_slime_occult.webp",
    floors: [1],
    isBoss: false,
  },
  {
    ...
    sprite: "/enemy_scrap_imp_occult.webp",
    floors: [2],
    isBoss: false,
  },
  {
    ...
    sprite: "/enemy_root_warden_occult.webp",
    floors: [5],
    isBoss: true,
    shieldBase: 28,
    phases: [
  ...
  },
  {
    ...
    sprite: "/enemy_lexicon_dragon_occult.webp",
    floors: [3],
    isBoss: false,
  },
  {
    ...
    sprite: "/enemy_archive_wisp_occult.webp",
    floors: [4],
    isBoss: false,
    shieldBase: 12,
  },
  ...
  },
  {
    ...
    attackFrequency: 3,
    special: "self_heal",
    sprite: "/enemy_hemophage_occult.webp",
    floors: [9],
    isBoss: false,
    shieldBase: 18,
  },
