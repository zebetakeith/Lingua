...
import type { MotionPreset } from "../game/presentation";
...
export const ENEMIES: EnemyDef[] = [
  {
    ...
    sprite: "/cute/enemy_bloop_slime_blob.png",
    motionPreset: "wobble",
    battleScale: 1.05,
    floors: [1],
    isBoss: false,
  },
  {
    ...
    sprite: "/cute/enemy_nibble_imp_blob.png",
    motionPreset: "dart",
    floors: [2],
    isBoss: false,
  },
  {
    ...
    sprite: "/cute/enemy_root_lump_blob.png",
    motionPreset: "stomp",
    battleScale: 1.12,
    floors: [5],
    isBoss: true,
  ...
  },
  {
    ...
    sprite: "/cute/enemy_doodle_dragon_blob.png",
    motionPreset: "bounce",
    floors: [3],
    isBoss: false,
  },
  {
    ...
    sprite: "/cute/enemy_page_wisp_blob.png",
    motionPreset: "float",
    floors: [4],
    isBoss: false,
    shieldBase: 12,
