...
export function getEncounterForFloor(floor: number): EncounterInfo {
  if (floor % 10 === 0) {
    return {
      ...
      modifierDescription: "The enemy has more HP, stronger shields, heavier hits, and the board starts cursed.",
      startingCurses: 4,
      hpMultiplier: 1.16,
  ...
  if (floor % 4 === 0) {
    return {
      ...
      modifierDescription: "The enemy gains a stronger shield and marks a few attack runes as cursed.",
      startingCurses: 2,
      hpMultiplier: 1.04,
